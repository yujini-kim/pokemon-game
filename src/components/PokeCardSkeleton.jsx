export default function PokeCardSkeleton() {
  return (
    <div className="flex flex-col justify-center items-center p-2 gap-y-2 w-full h-full bg-white rounded-lg">
      {/* 번호 */}
      ...
      <div className="flex gap-1">
        <div className="size-10 tablet:w-12 tablet:h-6 bg-gray-300 rounded-2xl animate-pulse"></div>
        <div className="size-10 tablet:w-12 tablet:h-6 bg-gray-300 rounded-2xl animate-pulse"></div>
      </div>
    </div>
  );
